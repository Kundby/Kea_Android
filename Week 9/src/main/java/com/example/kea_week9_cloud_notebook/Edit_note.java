...
public class Edit_note extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_back:
                if (!isEditing) {
                    MainActivity.addNewNote(new Note(headline_input.getText().toString(), body_input.getText().toString()));
                }else{
                     MainActivity.editNote(new Note(headline_input.getText().toString(), body_input.getText().toString(), id));
                }
